...
Each time the user interacts with the app, streamlit reruns the entire script from top to bottom. Session state  allows the app to store and remember values like the secret number, attempts, score, and history so the game can continue instead of restarting every time.  

---

## 5. Looking ahead: your developer habits

One habit I want to reuse is verifying AI-generated suggestions.

One thing I would do differently next time is be more precise with my prompts.

This project showed me that AI-generated code can be helpful and speed up the development process but it still requires careful testing, debugging, and understanding to ensure the code works as intended.